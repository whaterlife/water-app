        ...
        <div className="min-h-screen py-12">
          <div className="bg-white-300 flex items-center justify-center">
            <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-2xl shadow-red-600">
              {/* Form Title */}
              <h2 className="text-4xl font-extrabold text-center text-orange-800 mb-6">User Signup</h2>
              ...
              {/* SIGN-UP link */}
              <p >
                Already have an account?{" "}<Link to="/log"className="text-center mt-4 text-orange-700 text-sm" >Login</Link>
              </p>
            </div>
          </div>
        </div>
