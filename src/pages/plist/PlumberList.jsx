...
const PlumberList = () => {
    ...
    return (
        <section className={`${styles.backgroundImage} ${styles.fixing}`}>
            <div className={`${styles.contentWrapper} bg-white/90 p-6 rounded-lg shadow-lg m-6`}>
                    ...
                    {currentItems.map((plumber) => (
                        <div
                            ...
                            className={`${isGridView
                                ...
                                : "p-4 border border-gray-300 rounded-lg bg-white w-full sm:w-2/3 mx-auto"
                            }`}
                        >
                            {isGridView && (
                                <img
