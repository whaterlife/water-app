          ...
          <div className="bg-white-300 flex items-center justify-center">
            <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-2xl shadow-blue-600">
              ...
              <form className="space-y-4"
               ...
               <div>
                  <label htmlFor="buisnessname" className="block text-blue-700 text-sm font-bold mb-2">Buisness Name</label>
                  <input name="buisnessname" type="buisnessname" id="buisnessname" placeholder="Enter BuisnessName" className="w-full p-2 rounded bg-white-100 border border-cyan-200 focus:outline-none focus:ring-2 focus:ring-blue-300" required />
                </div>     
                ...
                <div>
                  ...
                  <input name="phone" type="phone" id="phone" placeholder="Enter phone Number" className="w-full p-2 rounded bg-white-100 border border-cyan-200 focus:outline-none focus:ring-2 focus:ring-blue-300" required />
                </div>
                <div>
