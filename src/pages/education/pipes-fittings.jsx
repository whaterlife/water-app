...
const Pipes = () => {
    return (
        <section className="relative text-lg text-blue-500 bg-[url('images/pback.png')] bg-no-repeat bg-cover bg-center py-10 px-4">
            ...
            <div className="relative z-10 max-w-screen-lg mx-auto">
                ...
                <div className="mt-10 text-center">
                    ...
                    <div className="flex gap-4 justify-center flex-wrap">
                        <img src="./images/pvc.jpg" alt="PVC pipe image" className="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 object-cover" />
                        <img src="./images/white.jpg" alt="White pipe image" className="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 object-cover" />
                        <img src="./images/coper.jpg" alt="Copper pipe image" className="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 object-cover" />
                    </div>
                </div>
                <div className="mt-10 text-center">
                    <h4 className="text-white mb-6 text-3xl md:text-4xl font-bold">Fittings</h4>
                    <div className="flex justify-center">
                        <img src="./images/fitting.jpg" alt="Fitting image" className="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 object-cover" />
                    </div>
                </div>
            </div>
        </section>
