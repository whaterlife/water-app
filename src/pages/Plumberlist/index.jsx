...
import { List, Grid } from "lucide-react"; // Importing icons from Lucide React
...
const PlumberList = () => {
    ...
    const itemsPerPage = 9; // Updated to show 9 items per page
        ...
        <section className="p-6 bg-gray-100 min-h-screen">
            ...
            <div className={`grid ${isGridView ? "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" : "grid-cols-1 space-y-4"}`}>
                {currentItems.map((plumber) => (
                    ...
                    >
                        {/* Conditionally Render Image in Grid View */}
                        {isGridView && (
                            <img
                                src={plumber.image}
                                alt={plumber.name}
