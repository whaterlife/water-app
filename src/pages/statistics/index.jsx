  ...
  return (
    <div className="text-center px-6 py-8">
      ...
      <div className="flex justify-center space-x-6 mb-4">
        <img src="./src/assets/images/piechart1.png" alt="Pie Chart" className="w-1/3 h-auto rounded-lg shadow-md" />
        <img src="./src/assets/images/waste.png" alt="Waste Chart" className="w-1/3 h-auto rounded-lg shadow-md" />
      </div>
